...
class Application(tk.Frame):
    ...
    def handle_click(self, number, event):
        # Ensure the field isn't taken yet
    ...
    def startGame(self):
        ...
        print(f'Playing mode nr. {mode} with difficulty {diff}')
    ...
    def handle_step(self, number):
        ...
        self.label_list[number]['text'] = self.board.signs[self.players[self.current_player].sign]

        # Check if the game has ended
        if self.board.isWin(self.players[self.current_player].sign, number):
            print(f'{self.players[self.current_player].name} has won the game.\n')
            messagebox.showinfo('The game has ended', f'{self.players[self.current_player].name} has won the game.')
            return True
    ...
    def set_field(self, number, sign):
        self.board.writeField(self.players[self.current_player].sign, number)
        self.label_list[number]['text'] = sign
